...
usdcAddress = Contract('0x1062BACf25bcC57C524cBA51D98d823B625f752f')
defi_contract = Contract ('0x813549dD128F3a356FCBC67AeDcDDff9AD2992DF') 
account = accounts.add(os.getenv("PRIVATE_KEY"))
accounts.add(os.getenv("PRIVATE_KEY1"))
accounts.add(os.getenv("PRIVATE_KEY2"))

class Form(FlaskForm):
    Faccounts = SelectField('Accounts', choices=['0xe17a6Bdd8041e37C4acE44db74811f00384F91E0',
                                                 '0x9234E4349973F2B8eBF027E328ecd279Bf8786D1',
                                                 '0x916B71993118CfBd3fFE3A4231631A43bd4C6a0f'])
